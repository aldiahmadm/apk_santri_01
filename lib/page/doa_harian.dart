import 'dart:convert';
import 'package:aplikasi_santri/model/model_satu.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart' as rootBundle;

class DoaHarian extends StatefulWidget {
  const DoaHarian({super.key});
...
class _DoaHarianState extends State<DoaHarian> {
  Future<List<ModelSunnah>> ReadJsonData() async {
    final jsondata = await rootBundle.rootBundle.loadString('assets/data/bacaan_satu.json');
    final list = json.decode(jsondata) as List<dynamic>;
    return list.map((e) => ModelSunnah.fromJson(e)).toList();
  }
  @override
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Doa Doa Yang Sering Di Ucapkan",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold),
